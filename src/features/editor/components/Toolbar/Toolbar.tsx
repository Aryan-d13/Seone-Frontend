...
export default function Toolbar({ mode = 'template' }: ToolbarProps) {
  const { template, zoom, setZoom, gridSnap, toggleGrid, activeManifest } =
    useTemplateStore();
  ...
  return (
    <div className="toolbar">
      ...
      <div className="toolbar__info">
        ...
        <span
          className={`toolbar__compositing-badge toolbar__compositing-badge--${mode === 'clip' ? 'clip' : template.compositing_mode}`}
        >
