      ...
      >
        ...
        <div
          style={{
            ...
            height: '80vh',
            background:
              'radial-gradient(circle, var(--accent-primary-muted) 0%, transparent 60%)',
            opacity: 0.8,
            pointerEvents: 'none',
            zIndex: 0,
          }}
        ...
        >
          ...
          >
            The rendering pipeline and core services are temporarily offline for
            structural upgrades. All active jobs have been safely paused and queued.
          </p>
