  ...
  useEffect(() => {
    ...
    async function fetchTemplates() {
      try {
        ...
        const data: TemplatesResponse | Template[] | { pages?: Template[] } =
          await response.json();
        ...
        const mockTemplates: Template[] = [
          {
            template_ref: 'modern-minimal/v1',
            name: 'Modern Minimal',
            slug: 'modern-minimal',
            category: 'Trending',
            aspect_ratio: '9:16',
