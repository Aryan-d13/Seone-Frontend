...
describe('Job Payload Contract & Invariants', () => {
  ...
  it('Contract: Keeps content language and copy language independent', async () => {
    ...
    act(() => {
      result.current.updateField(
        'youtubeUrl',
        'https://www.youtube.com/watch?v=hindi_video'
      );
    ...
    const calls = (authService.authFetch as unknown as ReturnType<typeof vi.fn>).mock
      .calls;
  ...
  it('Contract: Auto content still uses explicitly selected copy language', async () => {
    ...
    act(() => {
      result.current.updateField(
        'youtubeUrl',
        'https://www.youtube.com/watch?v=auto_video'
      );
  ...
  it('Contract: Maps English content + English copy', async () => {
    ...
    act(() => {
      result.current.updateField(
        'youtubeUrl',
        'https://www.youtube.com/watch?v=en_video'
      );
